...
function OrderComplete(): JSX.Element {
  ...
  return (
    <div className={styles.order_complete}>
      ...
      {ingredients.map((ingredient) => (<OrderCompleteCard id={ingredient}/>))}
      <div className={styles.footer}>
        <p className={'text text_type_main-default text_color_inactive'}>{formatOrderTime(order.updatedAt)}</p>
